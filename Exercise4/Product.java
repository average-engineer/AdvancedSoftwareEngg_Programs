...
public class Product extends Part{
    ...
    public Product(String id, String name){
        super(id,name); // Manually invoking the Superclass Constructor definition (Part Object) (Since Class constructor of the super class are not ingherited by the subclasses)
    ...
    // Adding a Part Requirement to the part requirement list of our Product
